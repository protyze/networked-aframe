...
/***/ (function(module, exports, __webpack_require__) {
	...
	var physics = __webpack_require__(48);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FirebaseWebRtcInterface = __webpack_require__(59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NetworkComponents = __webpack_require__(64);
...
/***/ (function(module, exports) {
	...
	var NetworkComponents = function () {
	    function NetworkComponents(entity, data) {
	        _classCallCheck(this, NetworkComponents);
	    ...
	    _createClass(NetworkComponents, [{
	        key: 'setData',
	        ...
	        key: 'initNetworkId',
	        value: function initNetworkId() {
	            this.networkId = this.data.networkId ? this.data.networkId : this.createNetworkId();
	        }
	    }, {
	        key: 'createNetworkId',
	        value: function createNetworkId() {
	            return Math.random().toString(36).substring(2, 9);
	        }
	    }, {
	        key: 'initNetworkParent',
	        value: function initNetworkParent() {
	        ...
	        key: 'registerEntity',
	        value: function registerEntity(networkId) {
	            naf.entities.registerLocalEntity(networkId, this.el);
	        }
	    }, {
	        key: 'listenForLoggedIn',
	        value: function listenForLoggedIn() {
	        ...
	        key: 'needsToSync',
	        value: function needsToSync() {
	            return naf.utils.now() >= this.nextSyncTime;
	        }
	    }, {
	        key: 'updateNextSyncTime',
	        value: function updateNextSyncTime() {
	            this.nextSyncTime = naf.utils.now() + 1000 / naf.options.updateRate;
	        }
	    }, {
	        key: 'getComponentsData',
	        value: function getComponentsData(schemaComponents) {
	        ...
	        key: 'getDirtyComponents',
	        value: function getDirtyComponents() {
	        ...
	        key: 'createSyncData',
	        value: function createSyncData(components) {
	            var data = {
	        ...
	        key: 'getAllSyncedComponents',
	        value: function getAllSyncedComponents() {
	            return this.data.components ? this.data.components : naf.schemas.getComponents(this.data.template);
	        }
	    }, {
	        key: 'networkUpdateHandler',
	        value: function networkUpdateHandler(data) {
	            var entityData = data.detail.entityData;
	            this.networkUpdate(entityData);
	        }
	    }, {
	        key: 'networkUpdate',
	        value: function networkUpdate(entityData) {
	            if (entityData[0] == 1) {
	        ...
	        value: function updateComponents(components) {
	        ...
	        key: 'updatePhysics',
	        value: function updatePhysics(physics) {
	        ...
	        key: 'handlePhysicsCollision',
	        value: function handlePhysicsCollision(e) {
	        ...
	        key: 'compressSyncData',
	        value: function compressSyncData(syncData) {
	            var compressed = [];
	            compressed.push(1);
	        ...
	        key: 'compressComponents',
	        value: function compressComponents(syncComponents) {
	            var compMap = {};
	        ...
	        key: 'decompressSyncData',
	        value: function decompressSyncData(compressed) {
	            var entityData = {};
	            entityData[0] = 1;
	        ...
	        key: 'decompressComponents',
	        value: function decompressComponents(compressed) {
	            var decompressed = {};
	        ...
	        key: 'isSyncableComponent',
	        value: function isSyncableComponent(key) {
	            if (naf.utils.isChildSchemaKey(key)) {
	                var schema = naf.utils.keyToChildSchema(key);
	        ...
	        key: 'hasThisChildSchema',
	        value: function hasThisChildSchema(schema) {
	        ...
	        key: 'updateCache',
	        value: function updateCache(components) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	AFRAME.registerComponent('networked-share', {
	  ...
	  networkUpdate: function networkUpdate(rawData) {
	    var entityData;
